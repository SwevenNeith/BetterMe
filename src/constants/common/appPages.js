...
export const APP_MAIN_PAGES = [
  ...
  { id: APP_PAGE_IDS.JEUX, defaultLabel: 'Jeux' },
  { id: APP_PAGE_IDS.SPORT, defaultLabel: 'Sport' },
  { id: APP_PAGE_IDS.WISHLIST, defaultLabel: 'WishList' },
  { id: APP_PAGE_IDS.FINANCES, defaultLabel: 'Finances' },
